...
import edu.columbia.ase.auctionhouse.core.app.AuctionHouseAuctionCapture;
...
public class AuctionHouseJSONAuctionCapture implements AuctionHouseAuctionCapture {
	...
	private String auctionsFileName;
	...
	public void loadAuctions() throws IOException {
		...
		//		new DateConverter("yyyy-MM-dd HH:mm:ss", null, TimeZone.getTimeZone("America/New_York")));
