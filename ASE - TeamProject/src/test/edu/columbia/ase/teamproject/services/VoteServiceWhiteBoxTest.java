...
public class VoteServiceWhiteBoxTest extends
	...
	public void testAddSecondVotes() {
		...
		secondVoteList.add(voteCategories.get(0).getVoteOptions().get(1)
				.getId());
		secondVoteList.add(voteCategories.get(1).getVoteOptions().get(1)
				.getId());
