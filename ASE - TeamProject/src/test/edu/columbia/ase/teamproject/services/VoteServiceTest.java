...
public class VoteServiceTest extends
	...
	public void setUp() throws ValidationException {
		...
		firstEvent = eventService.createEvent(voter, "FirstEvent Name",
		...
		secondEvent = eventService.createEvent(voter, "FirstEvent Name",
				"Event Description", EventType.PUBLIC, DateTime.now(), DateTime
						.now().plus(Duration.standardDays(1)),
				createBogusCategories(), new ArrayList<String>());
	}
	...
	public void testVerifyVotesRejectsVotesForOtherEvent() {
		...
		voteList.add(firstEvent.getVoteCategories().get(0).getVoteOptions()
				.get(0).getId());
		voteList.add(secondEvent.getVoteCategories().get(0).getVoteOptions()
				.get(0).getId());
		try {
	...
	public void testVerifyVotes() {
		...
		voteList.add(firstEvent.getVoteCategories().get(0).getVoteOptions()
				.get(0).getId());
		voteList.add(firstEvent.getVoteCategories().get(1).getVoteOptions()
				.get(0).getId());
	...
	public void testVerifyAddVoteRecordsVote() throws Exception {
		...
		VoteOption vo1o1 = voteOptionDao.find(firstEvent.getVoteCategories()
				.get(0).getVoteOptions().get(0).getId());
		VoteOption vo2o1 = voteOptionDao.find(firstEvent.getVoteCategories()
				.get(1).getVoteOptions().get(1).getId());
	...
	public void testVerifyAddVoteReplacesExistingVote() throws Exception {
		...
		VoteOption vo1o1 = voteOptionDao.find(firstEvent.getVoteCategories()
				.get(0).getVoteOptions().get(0).getId());
		VoteOption vo2o1 = voteOptionDao.find(firstEvent.getVoteCategories()
				.get(1).getVoteOptions().get(0).getId());
		...
		vo1o1 = voteOptionDao.find(firstEvent.getVoteCategories().get(0)
				.getVoteOptions().get(0).getId());
		vo2o1 = voteOptionDao.find(firstEvent.getVoteCategories().get(1)
				.getVoteOptions().get(0).getId());
		VoteOption vo1o2 = voteOptionDao.find(firstEvent.getVoteCategories()
				.get(0).getVoteOptions().get(1).getId());
		VoteOption vo2o2 = voteOptionDao.find(firstEvent.getVoteCategories()
				.get(1).getVoteOptions().get(1).getId());
