...
public class VoteServiceTest extends AbstractTransactionalJUnit4SpringContextTests {
	 ...
	 public void setUp() throws ValidationException {
		 ...
		 firstEvent = eventService.createEvent(voter, "FirstEvent Name",
				 "Event Description", EventType.PUBLIC, DateTime.now(),
	 ...
	 public void testVerifyAddVoteReplacesExistingVote() throws Exception {
		 ...
		 vo2o1 = voteOptionDao.find(firstEvent.getVoteCategories().get(1).getVoteOptions().get(1).getId());
		 VoteOption vo1o2 = voteOptionDao.find(firstEvent.getVoteCategories().get(0).getVoteOptions().get(0).getId());
