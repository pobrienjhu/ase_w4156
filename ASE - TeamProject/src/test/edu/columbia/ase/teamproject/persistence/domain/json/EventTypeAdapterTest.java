...
public class EventTypeAdapterTest {
	...
	public void testSerializeAndDeserializeVoteCategories() {
		...
		assertEquals(Long.valueOf(4561L),
				deserialized.getVoteCategories().get(0).getVoteOptions().get(0).getId());
		assertEquals(Long.valueOf(4562L),
				deserialized.getVoteCategories().get(0).getVoteOptions().get(1).getId());
		assertEquals(Long.valueOf(4563L),
				deserialized.getVoteCategories().get(0).getVoteOptions().get(2).getId());
		...
		assertEquals(Long.valueOf(7891L),
				deserialized.getVoteCategories().get(1).getVoteOptions().get(0).getId());
		assertEquals(Long.valueOf(7892L),
				deserialized.getVoteCategories().get(1).getVoteOptions().get(1).getId());
